    ...
    public void initMockData() {
        ...
        List<ParkingLot> mockData = List.of(
                createParkingLot(1L, "万达广场地下停车场", "北京市朝阳区建国路 93 号",
                        ...
                        new BigDecimal("4.5"), "https://example.com/parking1.jpg"),
                ...
                createParkingLot(2L, "国贸商城停车场", "北京市朝阳区建国门外大街 1 号",
                        ...
                        new BigDecimal("4.8"), "https://example.com/parking2.jpg"),
                ...
                createParkingLot(3L, "三里屯太古里停车场", "北京市朝阳区三里屯路 19 号",
                        ...
                        new BigDecimal("4.3"), "https://example.com/parking3.jpg"),
                ...
                createParkingLot(4L, "北京站停车场", "北京市东城区毛家湾胡同甲 13 号",
                        ...
                        new BigDecimal("4.0"), "https://example.com/parking4.jpg"),
                ...
                createParkingLot(5L, "奥林匹克公园停车场", "北京市朝阳区北辰东路 15 号",
                        ...
                        new BigDecimal("4.6"), "https://example.com/parking5.jpg"),
                ...
                createParkingLot(6L, "中关村广场停车场", "北京市海淀区中关村大街 1 号",
                        ...
                        "010-62345678", "充电桩，监控",
                        new BigDecimal("4.2"), "https://example.com/parking6.jpg"),
                ...
                createParkingLot(7L, "西单大悦城停车场", "北京市西城区西单北大街 131 号",
                        ...
                        new BigDecimal("4.4"), "https://example.com/parking7.jpg"),
                ...
                createParkingLot(8L, "首都机场 P3 停车场", "北京市朝阳区首都机场 1 号航站楼",
                        ...
                        new BigDecimal("4.7"), "https://example.com/parking8.jpg")
        );
